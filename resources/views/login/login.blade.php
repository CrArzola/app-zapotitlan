...
@section('title',"Login - SAL DE ORO")
					...
					<form class="md-float-material" name="user" action="{{ route('login') }}" method="POST">
						...
						<div class="row">
							<div class="col-xs-10 offset-xs-1">
								<button type="submit" class="btn button-green btn-md btn-block waves-effect text-center m-b-20">INGRESAR</button>
							</div>
						</div>
					</form>
				</div>
